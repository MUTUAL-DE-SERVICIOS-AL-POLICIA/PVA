...
<div class="doc">
    ...
    <div class="content">
        ...
        <p>
            ...
            Mediante CITE: <span class="">{{ $contract->rrhh_cite }} </span> de fecha {{ Carbon::parse($contract->rrhh_cite_date)->isoFormat('LL') }}, como resultado de la Convocatoria: {{ $contract->hiring_reference_number }} dentro del Proceso de Contratación para el cargo de: <span class="title-text">“{{ $contract->position->name }}”</span>, el Director General Ejecutivo y la Jefatura de la Unidad de Recursos Humanos de la MUSERPOL, instruyen la elaboración de Contrato del Personal Eventual de <span class="cap">{{ Util::fullName($contract->employee, 'lowercase') }}</span>.
        </p>
        @else
            ...
            <p>
                ...
                Mediante CITE: <span class="">{{ $contract->rrhh_cite }} </span> de fecha {{ Carbon::parse($contract->rrhh_cite_date)->isoFormat('LL') }}, como resultado de la Evaluación de Personal realizado mediante CITE: {{ $contract->performance_cite }}, el Director General Ejecutivo y la Jefatura de la Unidad de Recursos Humanos de la MUSERPOL, instruyen la elaboración de Contrato del Personal Eventual de <span class="cap">{{ Util::fullName($contract->employee, 'lowercase') }}</span>.
            </p>
            @else
            <p>
                ...
                Mediante CITE: <span class="">{{ $contract->rrhh_cite }} </span> de fecha {{ Carbon::parse($contract->rrhh_cite_date)->isoFormat('LL') }}, como resultado de la evaluación efectuada por parte del inmediato superior, en coordinación con el Director General Ejecutivo y la Jefatura de la Unidad de Recursos Humanos, se determinó la elaboración del Contrato del Personal Eventual de <span class="cap">{{ Util::fullName($contract->employee, 'lowercase') }}</span>.
            </p>
            @endif
        @endif
