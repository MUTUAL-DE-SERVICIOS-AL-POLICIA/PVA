      ...
      <div class="page-break px-4">
        <table class="w-100">
          <tr>
            ...
            <th class="w-25 no-padding no-margins align-top">
              <table class="table-code no-padding no-margins text-xxs">
                <tbody>
                  <tr>
        ...
        <div class="block">
          ...
          <table class="table-info w-50 m-b-5 text-center uppercase" style="float: left; margin-left: 1px;">
            ...
            <tr>
              <td class="{{ Util::departure_string_length($departure->employee->fullName()) }} data-row py-5 text-xs">{{ $departure->employee->fullName() }}</td>
            </tr>
            <tr class="bg-grey-darker text-xxs text-white">
              <td>MOTIVO</td>
            </tr>
            <tr>
              <td class="{{ Util::departure_string_length($departure->description) }} data-row py-5 text-xs">{{ $departure->description }}</td>
            </tr>
          </table>
          ...
          <table class="table-info w-100 m-b-10 uppercase text-xs">
            ...
            <tbody class="table-striped">
              ...
              <tr class="font-thin">
                ...
                <td class="{{ Util::departure_string_length($transfer['from']) }} text-center">{{ $transfer['from'] }}</td>
                <td class="{{ Util::departure_string_length($transfer['to']) }} text-center">{{ $transfer['to'] }}</td>
