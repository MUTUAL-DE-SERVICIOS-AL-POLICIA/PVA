    ...
    >
      <template slot="items" slot-scope="props">
        <tr>
          ...
          <td class="text-md-center" v-if="$store.getters.permissions.includes('delete-action') || $store.getters.role == 'admin'">
            <v-tooltip top>
...
export default {
  ...
  mounted() {
    ...
    if (this.$store.getters.permissions.includes('delete-action') || this.$store.getters.role == 'admin') {
