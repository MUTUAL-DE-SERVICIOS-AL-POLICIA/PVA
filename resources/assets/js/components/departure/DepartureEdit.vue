      ...
      try {
        if (val != null && !this.updateDeparture) {
          ...
          if (this.reasonSelected.timeRemaining > 0 || this.reasonSelected.reset == null) {
            ...
            if (['MATRIMONIO', 'NACIMIENTO DE HIJOS', 'MATERNIDAD', 'FALLECIMIENTO DE PADRES, ABUELOS, CONYUGE, HERMANOS O HIJOS - NIETOS O PARENTESCO ADOPTIVO', 'FALLECIMIENTO DE SUEGROS O CUÑADOS', 'ACCIDENTE GRAVE O ENFERMEDAD GRAVE DE HIJOS'].includes(this.reasonSelected.name)) {
              if (this.reasonSelected.name == 'MATERNIDAD') {
