...
class UpdateChargeAndPositions extends Migration
{
    ...
    public function up()
    {
        try {
            ...
            DB::table('positions')->where('item', 41)->where('active',true)->update(['name' => 'Jefe de Unidad de Otorgación de Fondo de Retiro Policial Solidario Cuota y Auxilio Mortuoria']);
