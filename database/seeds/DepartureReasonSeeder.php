...
class DepartureReasonSeeder extends Seeder
{
  ...
  public function run()
  {
    ...
    $group->departure_reasons()->saveMany([
      ...
      new App\DepartureReason(['name' => 'CON GOCE DE HABERES', 'days' => null, 'hours' => 16, 'reset' => 'annually', 'payable' => true, 'note' => true, 'description_needed' => false, 'description' => 'Para la resolución de asuntos de indole personal podrá solicitar 2 días hábiles fraccionados en el transcurso de 1 año, previa autorización del inmediato superior, los cuales no podrán ser consecutivos, ni anteriores o posteriores a las vacaciones o feriados.']),
      new App\DepartureReason(['name' => 'SIN GOCE DE HABERES', 'days' => null, 'hours' => null, 'reset' => null, 'payable' => false, 'note' => true, 'description_needed' => true, 'description' => 'Otros motivos sin goce de haberes con un maximo de 10 días habiles ']),
    ...
    $group->departure_reasons()->saveMany([
      ...
      new App\DepartureReason(['name' => 'MAMOGRAFÍA/PAPANICOLAOU', 'days' => null, 'hours' => 8, 'reset' => 'annually', 'payable' => true, 'note' => true, 'description_needed' => false, 'description' => 'Las servidoras públicas gozarán de 1 día para exámenes de mamogradía y papanicolau que puede ser fraccionado en 2 medias jornadas.']),
    ...
    $group->departure_reasons()->saveMany([
      new App\DepartureReason(['name' => 'DOCENCIA, BECAS, CURSOS, SEMINARIOS, POSTGRADOS', 'days' => null, 'hours' => null, 'reset' => null, 'payable' => true, 'note' => true, 'description_needed' => false, 'description' => 'Siempre que se encuentre vinculada al logro de objetivos establecidos en el Programa de Operaciones Anual Institucional']),
