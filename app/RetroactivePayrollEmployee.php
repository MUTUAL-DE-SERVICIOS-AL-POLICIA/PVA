...
class RetroactivePayrollEmployee {
	...
	public function add_previous_base_wage($value) {
		$this->previous_base_wage += $value;
	}
	public function add_base_wage($value) {
		$this->base_wage += $value;
	}
	public function add_previous_seniority_bonus($value) {
		$this->previous_seniority_bonus += $value;
	}
	public function add_seniority_bonus($value) {
		$this->seniority_bonus += $value;
	}
	public function add_monthly_reimbursement($value) {
		$this->monthly_reimbursement += $value;
	}
	public function add_seniority_bonus_reimbursement($value) {
		$this->seniority_bonus_reimbursement += $value;
	}
