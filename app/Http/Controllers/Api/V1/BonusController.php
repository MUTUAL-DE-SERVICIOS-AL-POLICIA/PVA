  ...
  public function print(Request $request, $id)
  {
    ...
    switch ($request['report_type']) {
      ...
      case 'csv':
        ...
        $content .= implode(',', ["Nro", "Tipo de documento de identidad", "Número de documento de identidad", "Lugar de expedición", "Fecha de nacimiento", "Primer Apellido", "Segundo Apellido", "Nombres", "País de nacionalidad", "Sexo", "Jubilado", "¿Aporta a la AFP?", "¿Persona con discapacidad?", "Tutor de persona con discapacidad", "Fecha de ingreso", "Fecha de retiro", "Motivo retiro", "Caja de salud", "AFP a la que aporta", "NUA/CUA", "Sucursal o ubicación adicional", "Clasificación laboral", "Cargo", "Modalidad de contrato", "Promedio haber básico", "Promedio bono de antigüedad", "Promedio bono producción", "Promedio subsidio frontera", "Promedio trabajo extraordinario y nocturno", "Promedio pago dominical trabajado", "Promedio otros bonos", "Promedio total ganado", "Meses trabajados", "Total ganado después de duodécimas", "\r\n"]);
